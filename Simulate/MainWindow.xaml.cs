    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            FaultQueue = new ObservableCollection<FaultQueueModel>
            {
                new FaultQueueModel
                {
                    Index = 1, MsgId = "0x100", MsgName = "EngineData",  Signal = "EngineSpeed",
                    FaultType = "Stuck at Value", FaultValue = "0x0000 (0 rpm)",
                    StartTime = "0 s", Duration = "10 s", Repeat = "Infinite", Mode = "Override",
                    Status = "Active",    StatusColor = "#10B981", StatusBg = "#064E3B"
                },
                new FaultQueueModel
                {
                    Index = 2, MsgId = "0x102", MsgName = "BrakeStatus", Signal = "BrakeApplied",
                    FaultType = "Bit Flip", FaultValue = "Bit 0",
                    StartTime = "5 s", Duration = "15 s", Repeat = "1", Mode = "Override",
                    Status = "Scheduled", StatusColor = "#38BDF8", StatusBg = "#0C2A4A"
                },
                new FaultQueueModel
                {
                    Index = 3, MsgId = "0x101", MsgName = "VehicleSpeed",Signal = "VehicleSpeed",
                    FaultType = "Offset",   FaultValue = "+20 km/h",
                    StartTime = "0 s", Duration = "20 s", Repeat = "3", Mode = "Override",
                    Status = "Pending",   StatusColor = "#94A3B8", StatusBg = "#1E2C3A"
                },
            };
